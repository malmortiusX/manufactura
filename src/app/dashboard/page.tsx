  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-5">
        ...
        <div className="xl:col-span-2 bg-white rounded-2xl border border-slate-200 p-6 shadow-sm">
          <div className="flex items-center justify-between mb-6">
            ...
            <span className="text-xs font-medium bg-primary-50 text-primary-600 px-3 py-1 rounded-full">2025</span>
          </div>
          <ResponsiveContainer width="100%" height={240}>
            <AreaChart data={chartData} margin={{ top: 0, right: 0, left: -20, bottom: 0 }}>
              <defs>
                <linearGradient id="colorValor" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="5%" stopColor="#f89520" stopOpacity={0.15} />
                  <stop offset="95%" stopColor="#f89520" stopOpacity={0} />
                </linearGradient>
              </defs>
              ...
              <Tooltip
                ...
                cursor={{ stroke: "#f89520", strokeWidth: 1, strokeDasharray: "4 4" }}
              />
              <Area type="monotone" dataKey="valor" stroke="#f89520" strokeWidth={2.5} fill="url(#colorValor)" dot={false} activeDot={{ r: 5, fill: "#f89520" }} />
            </AreaChart>
          </ResponsiveContainer>
        </div>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-2xl p-5 flex gap-4 items-start">
        <div className="text-primary-500 flex-shrink-0 mt-0.5">
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
          </svg>
        </div>
        <div>
          <p className="text-sm font-semibold text-primary-800">Template listo para conectar a SQL Server</p>
          <p className="text-xs text-primary-600 mt-1">
            Configura tu <code className="bg-primary-100 px-1 rounded">.env</code> con el string de conexión y ejecuta{" "}
            <code className="bg-primary-100 px-1 rounded">npx prisma db push</code> para crear las tablas automáticamente.
          </p>
        </div>
      </div>
    </div>
